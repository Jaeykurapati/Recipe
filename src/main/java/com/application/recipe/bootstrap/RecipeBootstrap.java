package com.application.recipe.bootstrap;


import com.application.recipe.model.*;
import com.application.recipe.repo.CategoryRepository;
import com.application.recipe.repo.RecipeRepository;
import com.application.recipe.repo.UnitOfMeasureRepository;
...
@Component
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setUrl("google");
        guacRecipe.setSource("recipes");
        ...
        tacosRecipe.setUrl("google");
        tacosRecipe.setSource("recipes");
